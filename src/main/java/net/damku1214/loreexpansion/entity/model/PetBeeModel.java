package net.damku1214.loreexpansion.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class PetBeeModel<T extends PetBeeEntity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(LoreExpansion.MOD_ID, "pet_bee"), "main");
    ...
    public PetBeeModel(ModelPart root) {
    ...
    public void renderToBuffer(@NotNull PoseStack poseStack, @NotNull VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
        ImmutableList.of(this.bone).forEach(p_349813_ -> p_349813_.render(poseStack, buffer, packedLight, packedOverlay, color));
    }
}
